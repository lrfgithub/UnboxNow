...
public class Address {
    ...
    private List<Shipment> shipmentsFrom;
    ...
    public List<Shipment> getShipmentsFrom() {
        return shipmentsFrom;
    }

    public void setShipmentsFrom(List<Shipment> shipmentsFrom) {
        this.shipmentsFrom = shipmentsFrom;
    }
    ...
    public void setShipmentTo(Shipment shipmentTo) {
